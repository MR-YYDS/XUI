...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-${arch}.tar.gz https://github.com/MR-YYDS/XUI/raw/refs/heads/main/x-ui-linux-${arch}.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/MR-YYDS/XUI/raw/refs/heads/main/x-ui-linux-${arch}.tar.gz"
        echo -e "开始安装 x-ui $1"
